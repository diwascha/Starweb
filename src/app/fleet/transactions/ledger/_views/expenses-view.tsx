                        ...
                        <TableBody>
                            {isLoading ? (
                                ...
                                <TableRow key={e.id} className="hover:bg-muted/30 h-14">
                                    ...
                                    <TableCell className="text-right font-black text-red-600 text-[0.6875rem] tabular-nums">Rs. {(e.amount + (e.extraAmount || 0)).toLocaleString(undefined, { minimumFractionDigits: 2 })}</TableCell>
