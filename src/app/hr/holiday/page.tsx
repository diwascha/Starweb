...
import type { PublicHoliday, LeaveRequest, Employee } from '@/lib/types';
        ...
        <div className="flex flex-col gap-8">
            <header className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex items-center gap-3">
                    <div className="p-2 bg-primary/10 rounded-xl"><CalendarCheck className="h-6 w-6 text-primary"/></div>
                    <div>
                        <h1 className="text-3xl font-black tracking-tighter text-gray-900 uppercase">Holidays & Leaves</h1>
                        <p className="text-muted-foreground text-sm font-medium">Manage time-off and organizational non-working days.</p>
                    </div>
                </div>
            </header>
