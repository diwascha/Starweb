                        ...
                        <Table className="text-[11px] border-collapse">
                            ...
                            {totals && (
                                <TableFooter className="bg-muted/50 font-black h-12 border-t-2">
                                    <TableRow>
                                        <TableCell className="sticky left-0 bg-background z-20 border-r pl-6 text-foreground uppercase tracking-tighter">Totals ({rows.length})</TableCell>
                                ...
                                <TableBody>
                                    {patternInsights.dayOfWeekPatterns.map(d => (
                                        <TableRow key={d.day} className="h-10 border-b">
                                            <TableCell className="pl-6 font-bold text-foreground">{d.day}</TableCell>
...
function PatternLine({ label, value }: { label: string; value: string }) {
    return (
        <div className="flex items-start justify-between gap-3 py-1 border-b border-dashed border-border last:border-0">
