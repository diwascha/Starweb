                    ...
                    {annualSummary.length > 0 ? annualSummary.map(s => (
                        <div key={`summary-${s.id}`} className="p-4 space-y-1">
                            <div className="flex justify-between items-baseline">
                                <span className="font-black text-[0.6875rem] text-foreground uppercase tracking-tighter">{s.employeeName}</span>
                            ...
                            {isLoading ? (
                                ...
                                <TableRow key={item.id} className="h-12 border-b hover:bg-muted/10 transition-colors">
                                    ...
                                    <TableCell className="text-center">
                                        {item.isEligible ?
                                            <Badge variant="outline" className="text-green-600 border-green-600 font-black uppercase text-[0.5rem] h-4">YES</Badge> :
                                            <Badge variant="outline" className="text-red-400 border-red-100 font-black uppercase text-[0.5rem] h-4">NO</Badge>
                                        }
                                    </TableCell>
                                    ...
                                    <TableCell className="pr-6 text-[0.625rem] text-muted-foreground italic truncate max-w-[220px]">{item.note}</TableCell>
                                </TableRow>
                            )) : (
