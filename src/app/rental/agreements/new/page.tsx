        ...
        <Card>
          ...
          <CardContent className="space-y-6">
             <div className="grid grid-cols-2 gap-x-8 gap-y-4 text-sm">
                ...
                <div><Label className="text-muted-foreground uppercase text-[0.625rem]">Rent / Mo</Label><p className="font-bold">Rs. {form.monthlyRent.toLocaleString()}</p></div>
                <div><Label className="text-muted-foreground uppercase text-[0.625rem]">Security Deposit</Label><p className="font-bold">Rs. {form.securityDeposit.toLocaleString()}</p></div>
