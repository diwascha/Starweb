        ...
        <Card>
          ...
          <CardContent className="space-y-6">
             <div className="grid grid-cols-2 gap-x-8 gap-y-4 text-sm">
                <div><Label className="text-muted-foreground uppercase text-[0.625rem]">Property</Label><p className="font-bold">{selectedProperty?.name}</p></div>
                <div><Label className="text-muted-foreground uppercase text-[0.625rem]">Unit Number</Label><p className="font-bold">{selectedUnit?.unitNumber}</p></div>
                <div className="col-span-2 border-t pt-2"><Label className="text-muted-foreground uppercase text-[0.625rem]">Tenant</Label><p className="font-bold text-lg">{selectedTenant?.name}</p></div>
                <Separator className="col-span-2" />
                <div><Label className="text-muted-foreground uppercase text-[0.625rem]">Rent / Mo</Label><p className="font-bold">Rs. {form.monthlyRent.toLocaleString('en-IN')}</p></div>
                <div><Label className="text-muted-foreground uppercase text-[0.625rem]">Security Deposit</Label><p className="font-bold">Rs. {form.securityDeposit.toLocaleString('en-IN')}</p></div>
                <div><Label className="text-muted-foreground uppercase text-[0.625rem]">Duration</Label><p className="font-bold">{toNepaliDate(form.startDate)} - {toNepaliDate(form.endDate)}</p></div>
                <div><Label className="text-muted-foreground uppercase text-[0.625rem]">Status Upon Save</Label><Badge className="bg-green-600">Active</Badge></div>
             </div>
          </CardContent>
          <CardFooter className="justify-between">
            <Button variant="ghost" onClick={handleBack}><ChevronLeft className="mr-2 h-4 w-4"/> Back</Button>
