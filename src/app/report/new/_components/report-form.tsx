    ...
    try {
      ...
      if (reportToEdit) {
        ...
        const newReport: Report = {
            ...
            serialNumber: '', // Will be generated by the useLocalStorage hook
            taxInvoiceNumber,
            challanNumber,
            quantity,
            product: selectedProduct,
        ...
        // The hook now handles serial number generation when the state is updated
        setReports(prevReports => [...prevReports, newReport]);
        toast({ title: 'Success', description: 'Report generated successfully.' });
        
        // We need to find the newly added report to get its ID for redirection
        // A slight delay might be needed for the state to update, but usually not with this setup.
        // For robustness, we could listen to a state change, but this is often sufficient.
