...
function ReportViewContent() {
    ...
    if (isLoading) return <div className="p-12 text-center h-[70vh] flex flex-col items-center justify-center gap-4"><Loader2 className="animate-spin h-8 w-8 text-primary"/><p className="text-sm font-bold uppercase tracking-widest text-muted-foreground">Authorizing document sequence...</p></div>;
